...
import static examples.jdk6.generics.watercolors.Watercolors.*;
import static examples.jdk6.net.mindview.util.Print.*;
import static examples.jdk6.net.mindview.util.Sets.*;

//: generics/WatercolorSets.java
import java.util.EnumSet;
import java.util.Set;

import examples.jdk6.generics.watercolors.Watercolors;
