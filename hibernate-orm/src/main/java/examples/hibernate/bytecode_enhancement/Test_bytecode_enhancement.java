...
import examples.hibernate.bytecode_enhancement.BidirectionalEntities.Book;
import examples.hibernate.bytecode_enhancement.BidirectionalEntities.Person;

@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
class Test_bytecode_enhancement {
	...
	@Test@Order(2)
	protected void bytecode_enhancement_test() {
	}

	@Test@Order(1) //未观察到特定现象
	...
	protected static void addMeta(MetadataSources meta) {
		meta.addAnnotatedClass(BidirectionalEntities.Book.class);
		meta.addAnnotatedClass(BidirectionalEntities.Person.class);
	...
	protected static void setUp() throws Exception {
		...
		additionalSettings.put("hibernate.connection.INIT",
				"CREATE SCHEMA IF NOT EXISTS lazy;SET SCHEMA lazy");
		...
		try {
			...
			Test_bytecode_enhancement.addMeta(meta);
