...
public class Test_embeddable_collections{
	...
	protected static void addMeta(MetadataSources meta) {
		meta.addAnnotatedClass(EmbeddableCollections.Book.class);
	...
	protected static void setUp() throws Exception {
		...
		additionalSettings.put("hibernate.connection.INIT","CREATE SCHEMA IF NOT EXISTS embeddable_collection;SET SCHEMA embeddable_collection");
		...
		try {
			...
			Test_embeddable_collections.addMeta(meta);
