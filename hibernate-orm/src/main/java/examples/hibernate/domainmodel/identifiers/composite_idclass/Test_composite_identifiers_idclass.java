...
public class Test_composite_identifiers_idclass {
	...
	protected static void addMeta(MetadataSources meta) {
		meta.addAnnotatedClass(CompositeIdClass.SystemUser.class);
	...
	protected static void setUp() throws Exception {
		...
		additionalSettings.put("hibernate.connection.INIT","CREATE SCHEMA IF NOT EXISTS IdClass;SET SCHEMA IdClass");
		...
		try {
			...
			Test_composite_identifiers_idclass.addMeta(meta);
