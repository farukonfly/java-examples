...
import examples.hibernate.locking.optimistic.version_timestamp_db.VersionTimeStamp_DB.Person;


@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
class Test_versionTimeStamp_DB {
	...
	protected static void addMeta(MetadataSources meta) {
		meta.addAnnotatedClass(VersionTimeStamp_DB.Person.class);
	...
	protected static void setUp() throws Exception {
		...
		additionalSettings.put("hibernate.connection.INIT",
				"CREATE SCHEMA IF NOT EXISTS locking;SET SCHEMA locking");
		...
		try {
			...
			Test_versionTimeStamp_DB.addMeta(meta);
