...
class Test_Hql_Jpql {
	...
	protected static void addMeta(MetadataSources meta) {
		meta.addAnnotatedClass(Hql_JPQL_Entities.Person.class);
		meta.addAnnotatedClass(Hql_JPQL_Entities.Phone.class);
		meta.addAnnotatedClass(Hql_JPQL_Entities.Partner.class);
		meta.addAnnotatedClass(Hql_JPQL_Entities.Call.class);
		meta.addAnnotatedClass(Hql_JPQL_Entities.Payment.class);
		meta.addAnnotatedClass(Hql_JPQL_Entities.CreditCardPayment.class);
		meta.addAnnotatedClass(Hql_JPQL_Entities.WireTransferPayment.class);
	}
	...
	protected static void setUp() throws Exception {
		...
		additionalSettings.put("hibernate.connection.INIT",
				"CREATE SCHEMA IF NOT EXISTS hql_jpql;SET SCHEMA hql_jpql");
