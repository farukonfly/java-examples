...
import examples.hibernate.fetch.dynamic_fetch.DynamicFetchEntities.Department;
import examples.hibernate.fetch.dynamic_fetch.DynamicFetchEntities.Employee;


@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
class Test_DynamicFetch {
	...
	protected static void addMeta(MetadataSources meta) {
		meta.addAnnotatedClass(DynamicFetchEntities.Department.class);
		meta.addAnnotatedClass(DynamicFetchEntities.Employee.class);
	...
	protected static void setUp() throws Exception {
		...
		try {
			...
			Test_DynamicFetch.addMeta(meta);
